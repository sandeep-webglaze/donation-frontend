...
export function DonateBanner({ siteName }: { siteName: string }) {
  return (
    <section className="container py-20 md:py-28">
      <div className="relative overflow-hidden rounded-[2.5rem] border bg-gradient-to-br from-primary to-primary/70 px-8 py-16 text-primary-foreground shadow-2xl shadow-primary/20 md:px-16">
        ...
        <div className="relative mx-auto max-w-2xl text-center">
          ...
          <h2 className="font-serif text-3xl font-bold leading-tight md:text-4xl">
            Every donation builds healthier, brighter futures
          </h2>
          <p className="mt-4 text-primary-foreground/85">
            Support {siteName} and help us honour centuries of tradition while
